...
Usage:
    ...
    codebase-compare --entry ref/main.py --entry my/main.py
"""
...
def run_trace_for_entry(entry_path: Path) -> dict | None:
    """Run codebase-trace for an entry point and return the result.
